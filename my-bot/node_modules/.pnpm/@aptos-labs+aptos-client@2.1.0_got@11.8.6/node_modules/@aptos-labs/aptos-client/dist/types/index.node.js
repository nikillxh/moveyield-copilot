...
function jsonRequest(requestOptions) {
    return __awaiter(this, void 0, void 0, function () {
        var params, method, url, headers, body, _a, http2, request, response, error_1, gotError;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    params = requestOptions.params, method = requestOptions.method, url = requestOptions.url, headers = requestOptions.headers, body = requestOptions.body, _a = requestOptions.http2, http2 = _a === void 0 ? true : _a;
                    request = {
                        http2: http2,
...
function bcsRequest(requestOptions) {
    return __awaiter(this, void 0, void 0, function () {
        var params, method, url, headers, body, _a, http2, request, _b, _c, _d, error_2, gotError;
